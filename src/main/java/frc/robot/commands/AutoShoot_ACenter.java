...
public class AutoShoot_ACenter extends Command {
  /** Creates a new A1. */
  public AutoShoot_ACenter() {
  ...
  public void execute() {
    ...
    RobotContainer.shouldersubsystem.enablemotionmagic(Constants.k_ShoulderPassPosition);
    RobotContainer.wristsubsystem.enablemotionmagic(Constants.k_WristPassPosition);
  }
