...
public class FiringSolutionSubsystem extends SubsystemBase {
  ...
  private void setUpSpeedLookUpTable() {
    ...
    wristAngle.put(100.0, (double) 0.406);
    wristAngle.put(105.00, (double) 0.411);
    wristAngle.put(110.00, (double) 0.413);
    wristAngle.put(115.00, (double) 0.413);
    wristAngle.put(120.00, (double) 0.413);
    wristAngle.put(125.00, (double) 0.413);
    wristAngle.put(130.00, (double) 0.413);
    wristAngle.put(999.0, (double) 0.413);
  }
